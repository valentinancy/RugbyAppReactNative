...
}}]);return Drawer;}(_react.Component);Drawer.tweenPresets={parallax:function parallax(ratio){var side=arguments.length>1&&arguments[1]!==undefined?arguments[1]:'left';var drawer=babelHelpers.defineProperty({},side,-150*(1-ratio));return{drawer:drawer};}};Drawer.propTypes={acceptDoubleTap:_react.PropTypes.bool,acceptPan:_react.PropTypes.bool,acceptTap:_react.PropTypes.bool,captureGestures:_react.PropTypes.oneOf([true,false,'open','closed']),children:_react.PropTypes.node,closedDrawerOffset:_react.PropTypes.oneOfType([_react.PropTypes.number,_react.PropTypes.func]),content:_react.PropTypes.node,disabled:_react.PropTypes.bool,elevation:_react.PropTypes.number,initializeOpen:_react.PropTypes.bool,open:_react.PropTypes.bool,negotiatePan:_react.PropTypes.bool,onClose:_react.PropTypes.func,onCloseStart:_react.PropTypes.func,onOpen:_react.PropTypes.func,onOpenStart:_react.PropTypes.func,openDrawerOffset:_react.PropTypes.oneOfType([_react.PropTypes.number,_react.PropTypes.func]),panThreshold:_react.PropTypes.number,panCloseMask:_react.PropTypes.number,panOpenMask:_react.PropTypes.number,side:_react.PropTypes.oneOf(['left','right']),styles:_react.PropTypes.object,tapToClose:_react.PropTypes.bool,tweenDuration:_react.PropTypes.number,tweenEasing:_react.PropTypes.string,tweenHandler:_react.PropTypes.func,type:_react.PropTypes.oneOf(['overlay','static','displace']),useInteractionManager:_react.PropTypes.bool,panStartCompensation:_react.PropTypes.bool,openDrawerThreshold:_react.PropTypes.any};Drawer.defaultProps={open:null,initializeOpen:false,type:'displace',closedDrawerOffset:0,openDrawerOffset:0,panThreshold:0.25,panOpenMask:null,panCloseMask:null,tweenHandler:null,tweenDuration:250,tweenEasing:'linear',disabled:false,negotiatePan:false,captureGestures:'open',acceptDoubleTap:false,acceptTap:false,acceptPan:true,tapToClose:false,styles:{},elevation:0,onOpen:function onOpen(){},onClose:function onClose(){},side:'left',useInteractionManager:false};Drawer.contextTypes={drawer:_react.PropTypes.object};Drawer.childContextTypes={drawer:_react.PropTypes.object};exports.default=Drawer;
