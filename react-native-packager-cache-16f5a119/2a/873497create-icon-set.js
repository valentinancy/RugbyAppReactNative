...
}}]);return Icon;}(_react.Component);Icon.propTypes=babelHelpers.extends({},_reactNative.Text.propTypes,{name:IconNamePropType.isRequired,size:_react.PropTypes.number,color:_react.PropTypes.string});Icon.defaultProps={size:DEFAULT_ICON_SIZE,allowFontScaling:false};
