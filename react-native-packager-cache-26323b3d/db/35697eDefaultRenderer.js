...
DefaultRenderer=function(_Component){babelHelpers.inherits(DefaultRenderer,_Component);
...
_this.renderHeader=_this.renderHeader.bind(_this);return _this;
...
}},{key:'getPanHandlers',value:function getPanHandlers(
